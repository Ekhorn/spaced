...
Build JavaScript libraries used in web-frontend. Only required initially or when changed are made to packages **referenced** in [srcs/app/tsconfig.json](srcs/app/tsconfig.json).
