...
function getArrayJsValueFromWasm0(ptr, len) {
  ...
  for (const element of slice) {
    result.push(wasm.__wbindgen_export_0.get(element));
  }
...
function passArrayJsValueToWasm0(array, malloc) {
  ...
  for (const [i, element] of array.entries()) {
    mem[ptr / 4 + i] = addToExternrefTable0(element);
  }
...
const DetectedLineFinalization = new FinalizationRegistry((ptr) =>
...
const ImageFinalization = new FinalizationRegistry((ptr) =>
...
const OcrEngineFinalization = new FinalizationRegistry((ptr) =>
...
const OcrEngineInitFinalization = new FinalizationRegistry((ptr) =>
...
export class OcrEngineInit {
  ...
  setRecognitionModel(data) {
    try {
      ...
      const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
      const len0 = WASM_VECTOR_LEN;
      wasm.ocrengineinit_setRecognitionModel(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
...
const RotatedRectFinalization = new FinalizationRegistry((ptr) =>
...
export class RotatedRect {
  ...
  corners() {
    try {
      ...
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var v1 = [...getArrayF32FromWasm0(r0, r1)];
      wasm.__wbindgen_free(r0, r1 * 4, 4);
      return v1;
    } finally {
      wasm.__wbindgen_add_to_stack_pointer(16);
...
const TextLineFinalization = new FinalizationRegistry((ptr) =>
...
const TextWordFinalization = new FinalizationRegistry((ptr) =>
